...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
            ...
            array('seller'=>" ",'title'=>'Ikan Piranha','description'=>"Piranha atau piraña adalah ikan air tawar omnivora yang hidup di sungai-sungai di Amerika Selatan. Di sungai-sungai Venezuela, mereka disebut caribes. Mereka terkenal dengan gigi tajam dan pemakan daging. Meskipun Hollywood sering memberikan citra negatif pada piranha, mereka sebenarnya tidak seberbahaya itu, dan sering dibudidayakan di rumah dan kantor. ", 'image'=> "https://i1.wp.com/www.ekor9.com/wp-content/uploads/2018/10/info-tentang-ikan-piranha.jpg?resize=600%2C381&ssl=1",'price'=>284,'stock'=>200),
            );
